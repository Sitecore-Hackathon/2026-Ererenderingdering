...
export const getAvailableRenderingsTest: ContentItem = {
...
try {
  ...
  if (!renderings) throw new Error('renderings is null');
  passed = true;
} catch (e) {
...
<div style="font-family:var(--font-sans),system-ui,sans-serif;padding:16px;">
  <div style="display:flex;align-items:center;gap:12px;margin-bottom:12px;">
    ...
    <strong>getAvailableRenderings</strong>
...
\`);
print(status + ' getAvailableRenderings (' + duration + 'ms)');`,
  },
};
