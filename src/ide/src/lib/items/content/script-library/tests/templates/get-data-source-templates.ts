...
export const getDataSourceTemplatesTest: ContentItem = {
...
try {
  ...
  if (!templates) throw new Error('data source templates is null');
  passed = true;
} catch (e) {
...
<div style="font-family:var(--font-sans),system-ui,sans-serif;padding:16px;">
  <div style="display:flex;align-items:center;gap:12px;margin-bottom:12px;">
    ...
    <strong>getDataSourceTemplates</strong>
...
\`);
print(status + ' getDataSourceTemplates (' + duration + 'ms)');`,
  },
};
